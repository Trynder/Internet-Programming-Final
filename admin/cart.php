        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a href="users.php" class="btn btn-sm btn-primary btn-flat"><i class="fa fa-arrow-left"></i> Kullanıcılar</a>
            </div>
            <div class="box-body">
                      ...
                      foreach($stmt as $row){
                        echo "
                          <tr>
                            ...
                            <td>".$row['quantity']."</td>
                            <td>
                              <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['cartid']."'><i class='fa fa-edit'></i> Miktarı Düzenle</button>
                              <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['cartid']."'><i class='fa fa-trash'></i> Sil</button>
                            </td>
                          </tr>
                        ";
                      }
