<?php
	...
	if(isset($_POST['print'])){
	    ...
	    $content .= '
	      	...
	      	<h4 align="center">SATIŞ RAPORLARI</h4>
	      	<h4 align="center">'.$from_title." - ".$to_title.'</h4>
	      	<table border="1" cellspacing="0" cellpadding="3">  
	           <tr>  
	           		<th width="15%" align="center"><b>Tarih</b></th>
	                <th width="30%" align="center"><b>Alıcı Adı</b></th>
					<th width="40%" align="center"><b>İşlem#</b></th>
					<th width="15%" align="center"><b>Adet</b></th>  
	           </tr>  
	      ';  
		...
		$_SESSION['error'] = 'Satış baskısı sağlamak için tarih aralığına ihtiyacınız var';
