            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="cart_add.php">
                ...
                <div class="form-group">
                    <label for="product" class="col-sm-3 control-label">Ürün</label>
                ...
                <div class="form-group">
                    <label for="quantity" class="col-sm-3 control-label">Miktar</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="cart_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_quantity" class="col-sm-3 control-label">Miktar</label>
