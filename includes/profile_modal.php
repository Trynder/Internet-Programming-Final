    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title"><b>Tüm İşlem Detayı</b></h4>
            </div>
            <div class="modal-body">
              <p>
                Tarih: <span id="date"></span>
                <span class="pull-right">İşlem#: <span id="transid"></span></span> 
              </p>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title"><b>Hesap Güncelle</b></h4>
            </div>
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="contact" class="col-sm-3 control-label">İletişim Bilgisi</label>
                ...
                <div class="form-group">
                    <label for="curr_password" class="col-sm-3 control-label">Mevcut Şifre</label>

                    <div class="col-sm-9">
                      <input type="password" class="form-control" id="curr_password" name="curr_password" placeholder="Mevcut şifre bilgileri kaydedildi" required>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
